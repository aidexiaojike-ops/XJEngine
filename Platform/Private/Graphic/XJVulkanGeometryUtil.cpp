...
namespace XJ
{
    XJVulkanGeometryUtil::XJVulkanGeometryUtil(/* args */)
    {
    }
    
    XJVulkanGeometryUtil::~XJVulkanGeometryUtil()
    {
    }
    void XJVulkanGeometryUtil::CreateCube(float leftPlane, float rightPlane, float bottomPlane, float topPlane, float nearPlane, float farPlane,
                                       ...
                                       const bool bUseNormals, const glm::mat4 &relativeMat)
    {
        ...
        if(bUseTextcoords)
        {
            ...
            vertices[5]. texcoord0 = glm::vec2(0.0f, 0.0f);
            vertices[6]. texcoord0 = glm::vec2(0.0f, 1.0f);
            vertices[7]. texcoord0 = glm::vec2(1.0f, 1.0f);
            vertices[8]. texcoord0 = glm::vec2(1.0f, 0.0f);
            vertices[9]. texcoord0 = glm::vec2(0.0f, 0.0f);
            vertices[10].texcoord0 = glm::vec2(0.0f, 1.0f);
            vertices[11].texcoord0 = glm::vec2(1.0f, 1.0f);
            vertices[12].texcoord0 = glm::vec2(1.0f, 0.0f);
            vertices[13].texcoord0 = glm::vec2(0.0f, 0.0f);
            vertices[14].texcoord0 = glm::vec2(0.0f, 1.0f);
            vertices[15].texcoord0 = glm::vec2(1.0f, 1.0f);
            vertices[16].texcoord0 = glm::vec2(1.0f, 0.0f);
            vertices[17].texcoord0 = glm::vec2(0.0f, 0.0f);
            vertices[18].texcoord0 = glm::vec2(0.0f, 1.0f);
            vertices[19].texcoord0 = glm::vec2(1.0f, 1.0f);
            vertices[20].texcoord0 = glm::vec2(1.0f, 0.0f);
            vertices[21].texcoord0 = glm::vec2(0.0f, 0.0f);
            vertices[22].texcoord0 = glm::vec2(0.0f, 1.0f);
            vertices[23].texcoord0 = glm::vec2(1.0f, 1.0f);
        }
        if(bUseNormals)
        {
