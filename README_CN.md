...
| **ImGui 编辑器** | 支持 Docking、多视口、拖拽，内建面板（Hierarchy、Inspector、Content Browser、Console、Scene/Game Preview） |
...
- **编辑器系统**：`XJUIContext`、`XJEditorRenderer`、`XJEditorUILayer`、`XJEditorUIConfig`、`XJEditorDragPayload`、`XJScenePreview`、`XJGamePreview`、编辑器面板
