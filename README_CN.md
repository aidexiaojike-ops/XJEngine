...
| **资产系统** | Asset/Resource 双层架构，glTF 2.0 导入，资产注册表与引导，场景实例化，网格/纹理/材质加载器 |
| **ImGui 编辑器** | 支持 Docking、多视口，内建面板（Hierarchy、Inspector、Content Browser、Console、Scene/Game Preview） |
...
- **资产系统**：`XJModelImporter`、`XJTextureImporter`、`XJAssetRegistry`、`XJAssetBootstrap`、`XJSceneRuntimeUtil`、`XJMeshAssetLoader`
- **编辑器系统**：`XJUIContext`、`XJEditorRenderer`、`XJEditorUILayer`、`XJEditorUIConfig`、`XJScenePreview`、`XJGamePreview`、编辑器面板
